...
CC='/tmp/darwin-clang-cross/bin/aarch64-apple-darwin24-clang'
CXX='/tmp/darwin-clang-cross/bin/aarch64-apple-darwin24-clang++'
AR='/usr/bin/llvm-ar'
AS='/usr/bin/llvm-as'
LD='/tmp/darwin-clang-cross/bin/aarch64-apple-darwin24-ld'
NM='/usr/bin/llvm-nm'
